#include "report/data_unit_lex_order.hpp"

bool data_unit_lex_order::operator()(const data_unit & lhs, const data_unit & rhs) {
...
bool data_unit_lex_order::operator()(const data_unit & lhs, const std::tuple<std::size_t, std::size_t, double>& rhs) {
...
bool data_unit_lex_order::operator()(const std::tuple<std::size_t, std::size_t, double>& lhs, const data_unit & rhs) {
